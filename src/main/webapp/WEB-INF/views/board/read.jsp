	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview active"><a href="#"> <i
				...
				<ul class="treeview-menu">
					<li><a href="./board/register"><i class="fa fa-circle-o"></i>
							General Elements</a></li>
					<li class="active"><a href="./board/listAll"><i
				...
				<div class="box box-info">
					...
					<div class="box-body">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="inputRegDate" class="col-sm-2 control-label">Register
									Date</label>
								<div class="col-sm-10">
									<fmt:parseDate value='${boardVO.regDate }' var='regdate1'
										pattern="yyyy-mm-dd HH:mm" />
									<input type="text" class="form-control" name="writer"
										value="<fmt:formatDate value="${regdate1}" pattern="yyyy-MM-dd HH:mm"/>"
										readonly="readonly">
								</div>
							</div>
						</div>
