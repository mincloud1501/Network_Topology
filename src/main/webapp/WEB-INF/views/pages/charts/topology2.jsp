...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/dist/css/webvowl.css" />
    <link rel="stylesheet" type="text/css" href="/resources/dist/css/webvowl.app.css" />
    <link rel="icon" href="/resources/dist/image/skb_logo.png" type="x-icon" />
...
<body>
        ...
        <section id="canvasArea">
            ...
            <div id="menuContainer">
                ...
                <ul id="m_select" class="toolTipMenu noselect">
                    <li><a href="#foaf" id="foaf">Network Topology by minCloud</a></li>
    ...
    <script src="/resources/dist/js/d3.min.js"></script>
    <script src="/resources/dist/js/webvowl.js"></script>
    <script src="/resources/dist/js/webvowl.app.js"></script>
    <script>
